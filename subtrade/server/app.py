...
from subtrade.core.database import Database
from subtrade.core.engine import SimulationEngine
from subtrade.server.graphql.types import Query, Mutation

class Server:
    def __init__(self, port: int = 8000):
        self.app = FastAPI(title="Subtrade Server")
        self.port = port
        self.db = Database()
    ...
    def run(self):
        import uvicorn
        print(f"Starting Subtrade server on port {self.port}")
